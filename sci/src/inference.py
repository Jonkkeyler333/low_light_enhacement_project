...
def main():
    ...
    model_path = 'checkpoints/exp1/model_epoch_100.pth'
    ...
    with torch.inference_mode():
        ...
        for img_name in sorted(os.listdir(input_folder)):
            ...
            # map_error_norm = np.clip((map_error - map_error.min()) / (map_error.max() - map_error.min()) * 255.0, 0, 255).astype('uint8')
